<?php
// ============================================
// SOLEMATCH - Checkout with Khalti
...
// Database configuration - Direct connection (no includes)
$db_host = 'localhost';
$db_name = 'sole_match';
$db_user = 'root';
$db_pass = '';
...
// ============================================
// KHALTI CONFIGURATION - Direct in file
// ============================================
...
define('KHALTI_SANDBOX_SECRET_KEY', 'test_secret_key_1234567890'); // REPLACE WITH YOUR TEST KEY

// Production Credentials (Get from https://admin.khalti.com)
define('KHALTI_LIVE_URL', 'https://khalti.com/api/v2/');
define('KHALTI_LIVE_SECRET_KEY', 'live_secret_key_1234567890'); // REPLACE WITH YOUR LIVE KEY

// Site URL (Update with your actual site URL)
    ...
    if (empty($errors)) {
        try {
            ...
            if ($payment_method === 'khalti') {
                ...
                $khalti_response = initiateKhaltiPayment(
                    $order_id,
                    $total,
                    'Order #' . $order_number,
                    $customer_info
                ...
                if ($khalti_response['success']) {
                    $_SESSION['khalti_pidx'] = $khalti_response['pidx'];
                    $_SESSION['khalti_order_id'] = $order_id;
                    header('Location: ' . $khalti_response['payment_url']);
                    exit;
                } else {
                    $order_error = 'Failed to initiate Khalti payment: ' . ($khalti_response['error'] ?? 'Unknown error');
                }
            } else {
...
<body>
    ...
    <script>
        ...
        console.log('📦 SOLEMATCH - Checkout with Khalti');
